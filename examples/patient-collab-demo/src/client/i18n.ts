...
const en = {
  ...
  "app.docs": "How this demo works",
  "app.sample": "Sample Application",
  "server.window": "Server terminal",
  "server.note":
    "Not part of the application — this is a debug view of the sample server's SQLite database, the rows the projection engine writes from the shared document.",
  "server.note.popHint": "Pop it out to see the app the way a user would.",
  "server.popOut": "Open the server terminal in its own window",
  "server.popOut.short": "Pop out",
  "server.info": "What is this window?",
  "server.log": "YORM log",
  "server.log.empty": "Nothing triggered since this page loaded — edit the Patient to see the projection engine react.",
  "server.poppedOut": "The server terminal is open in its own window.",
  "server.focus": "Show it",
  "connection.connecting": "Connecting…",
  "connection.connected": "Connected",
  "collab.trigger": "Room status",
  "collab.editing": "{names} editing",
  "collab.peersTitle": "In the room ({count})",
  ...
  "collab.user.value": "{name} · {role} · {mode}",
  "event.edited": "edited {field}",
  "event.policy": "autosave policy → {policy}",
  "event.commit": "projection commit · {statements} statements (doc v{version})",
  "event.proposed": "{actor} suggested a change to {path}",
  "event.proposalResolved": "{status}: {path}",
  ...
  "opt.female": "Female",
  "opt.unknown": "Unknown",
  "rows.title": "Sample Server",
  "rows.subtitle":
    "SQLite projection rows written by the projection engine from the canonical document — never by the UI",
  "rows.empty": "No rows",
